...
#### 2. From Engagement to Exit: A Scalable Churn Prediction Engine for Recruitment Platforms (Python)(Synthetic Data Study) [(Click here to see full)](https://github.com/shanurwan/Customer-Churn-Analytic/blob/main/README.md)
...
#### 3. Self-Updating Job Tracker with VBA – No Subscriptions, Just Smart Sheets [(Click here to see full)](https://github.com/shanurwan/Excel-Job-Tracker/blob/main/README.md)
